...
if (count($_POST) > 0) {
    ...
    if (isset($dados['nascimento'])) {
        ...
        if (!$data) {
            $erros['nascimento'] = 'Data em formato inválido';
        }
    }
...
<?php foreach ($erros as $erroUnico) : ?>
...
<form action="/exercicio.php" method="get">
    ...
    <div class="form-group row">
        <div class="col-sm-10">
            <input type="number" name="codigo" value="<?= $_GET['codigo'] ?>" placeholder="Informe o código para consultar" class="fomr-control">
        </div>
        <div class="col-sm-2">
...
<form action="#" method="post">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control <?= $erros['nascimento'] ? 'is-invalid' : '' ?>" id="nascimento" name="nascimento" placeholder="Data Nascimento" value="<?= $dados['nascimento'] ?>">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="filhos">Quant. Filhos</label>
            <input type="number" class="form-control <?= $erros['filhos'] ? 'is-invalid' : '' ?>" id="filhos" name="filhos" placeholder="Quant. Filhos" value="<?= $dados['filhos'] ?>">
